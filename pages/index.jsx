	...
	return (
		<div>
			<div className="relative flex items-center content-center justify-center w-auto h-full">
				...
				>
					<SwiperSlide>
						<img className="object-cover object-center w-screen h-screen" src="/images/mixa01.jpeg" />
					</SwiperSlide>
					<SwiperSlide>
						<img className="object-cover object-center w-screen h-screen" src="/images/mixa02.jpeg" />
					</SwiperSlide>
				</Swiper>
			</div>
			<div className="flex flex-col-reverse items-stretch justify-center w-auto py-20 space-x-4 tracking-wide md:py-24 lg:py-36 lg:flex-row">
				<div className="grid content-center gap-5 p-5 mx-6 lg:mx-0 lg:w-3/5">
					<div className="text-6xl font-semibold tracking-widest capitalize text-stone-800">tentang MIXA</div>
