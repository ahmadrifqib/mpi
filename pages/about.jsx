				...
				<div className="mx-auto container-none lg:container">
					<div className="mx-5 text-xl font-light text-justify md:mx-14 lg:mx-52">
						<p className="mb-10">
							...
							pembangunan dan pekerasan tanah, sekarang berkembang menjadi sebuah perusahaan yang bergerak
							di bidang Kontraktor Renovasi, Bangunan Baru, Interior Design dan Pekerjaan Landscape.
						</p>
						<p className="mb-10">
							Komitmen PT MPI (Mixa Perkasa Indonesia) untuk menyelesaikan setiap karya konstruksi yang
							telah dipercayakan, tidak terlepas dari peran setiap anggota dalam melakukan perencanaan,
							pelaksanaan, dan pengendalian proyek dengan berbagai manajemen dan metode konstruksi yang
							efektif, efisien, serta memperhatikan standar K3 (Keselamatan Kesehatan Kerja) dan
							lingkungan kerja.
						</p>
						<p className="mb-10">
						...
						<p className="mb-10">
							Kiprah MPI dalam merampungkan karya-karya konstruksi juga tidak akan berjalan dengan baik
							tanpa adanya dukungan dan kerjasama yang baik dengan seluruh mitra kerja perusahaan
							(Supplier Material, Subkontraktor, Pihak Perbankan, dan SDM yang memiliki kompetensi yang
							tinggi)
						</p>
					</div>
