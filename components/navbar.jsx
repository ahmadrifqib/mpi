		...
		<>
			<div className="flex items-center justify-between py-1 mx-auto bg-orange-50/90 lg:px-10 xl:px-20">
				...
				<div className="hidden space-x-5 text-2xl font-semibold text-stone-500 lg:block">
					<Link href="/">
						<a className="hover:text-stone-800">Beranda</a>
					</Link>
					<Link href="/project">
						<a className="hover:text-stone-800">Proyek</a>
					</Link>
					<Link href="/product">
						<a className="hover:text-stone-800">Produk</a>
					</Link>
					<Link href="/about">
						<a className="hover:text-stone-800">Tentang Kami</a>
					</Link>
				</div>
			...
			>
				<Link href="/">
					<a className="py-6 border-orange-200 border-y-2 hover:border-y hover:border-b-4 hover:border-orange-400 hover:bg-orange-200">
						Beranda
					</a>
				</Link>
				<Link href="/project">
					<a className="py-6 border-b-2 border-orange-200 hover:border-y hover:border-b-4 hover:border-orange-400 hover:bg-orange-200">
						Proyek
					</a>
				</Link>
				<Link href="/product">
